                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className='mt-4 d-flex justify-content-around flex-wrap'>
                            <div className={`col-5 col-md-3 ${style.card} border p-2 text-center text-white rounded-4  py-3 shadow-lg`}>
                            ...
                            <div className={`col-5 col-md-3 mt-4 mt-md-0 ${style.card} border p-2 text-center text-white rounded-4  py-3 shadow-lg`}>
                                <div className={`${style.crdicon}  mx-auto rounded-circle text-white`}>
                                    <HiOutlineNewspaper className={` ${style.icon} fs-1 mt-2 `} />
                                </div>
                        ...
                        <button className='btn text-white  px-3  col-md-2 col-4 mx-auto mt-5 mb-2  shadow-lg'>
                            Get Started
                        </button>
                    </div>
                </div>
